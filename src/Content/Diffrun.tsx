...
const Diffrun = () => {
  return (
    <>
      <Chapter title="Inngangur">
        <p>
          Vandinn sem Calculus reynir að leysa er hraði, meira ákvæmt, er það
          hraði hluts á einangruðum tímapunkti.
          <br />
          Vandinn með þessa spurningu er sá að hraði er ekki til ef bara horft á
          einn tímapunkt.
          <br />
          Skilgreining hraða er vegalengd á tíma, (algengasta formið er kílómeter
          á sekóntu \(km \over s\)). Skiljanlega er þá erfitt að svara því hversu
          hratt eitthvað fer ef við höfum enga vegalengd né tímabil til að vinna með. Þar
          af leiðandi er erfitt að svara hve hratt, t.d. bíll er að keyra á
          einhverjum einstökum tímapunkti.
        </p>
      </Chapter>
      <Chapter title="Diffrun">
        ...
        <div className="Side">
          ...
          <ScrollText>
            ...
            að finna halla. Halli á tilteknum <u>punkti</u> er flóknara því hér
            höfum við bara einn punkt.
            <br />
            <br />
        ...
        <div className="Side">
          ...
          <ScrollText>
            ...
            ekki á \(P\) sjálfum. Þrátt fyrir það er þetta ágæt ágiskun og skref
            í rétta átt til að finna hver hallatalan á \(P\) er.
            ...
            0\) (núll vigur) er hallatalan því \(\frac 0 0\), sem er ógild
            jafna.
          </ScrollText>
        </div>
        <p>
